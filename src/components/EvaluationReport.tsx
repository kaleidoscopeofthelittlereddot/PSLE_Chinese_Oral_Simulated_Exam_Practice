...
5. 针对 Q1 - Q4 提供 4 道题目的 MOE 标准满分示范答案。`;
  ...
  const modelAnswers = report.modelAnswers || {
    ...
    q2: `在日常生活中，我也遇到过与“${cleanTheme}”相关的经历。有一次在搭乘公共交通和学校活动时，我主动帮助有需要的人。虽然付出了少许努力，但看到对方开心的笑容，我心里感到无比满足与自豪。`,
    q3: `我完全同意“关于${cleanTheme}，人人有责”这句话。首先，美好的环境需要大家共同呵护；其次，良好的言行不仅体现个人素质，更是社会文明的基石。因此，我们每个人都应该从自己做起。`,
    q4: `为了推广“${cleanTheme}”，我有几点切实的建议：首先，学校可以在品格教育课上举办主题活动；其次，政府部门可以张贴有创意的手绘宣传海报；最后，家长要以身作则，给孩子们树立良好的榜样。`,
  };
